...
requireBundledText('const SITE_LABEL_MIN_ZOOM = 2.35;', "Bundled Android app must show site labels earlier before close zoom.");
requireBundledText('const SITE_POINT_LABEL_MIN_ZOOM = 2.45;', "Bundled Android app must show point labels earlier before close zoom.");
