...
requireBundledText('const SITE_LABEL_MIN_ZOOM = 3.25;', "Bundled Android app must show site labels before close zoom.");
requireBundledText('const SITE_POINT_LABEL_MIN_ZOOM = 3.35;', "Bundled Android app must show point labels before close zoom.");
