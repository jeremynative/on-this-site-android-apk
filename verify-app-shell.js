...
requireBundledText('const SITE_LABEL_MIN_ZOOM = 8.7;', "Bundled Android app must show site labels at the current mobile zoom threshold.");
requireBundledText('const SITE_POINT_LABEL_MIN_ZOOM = 9.15;', "Bundled Android app must show point labels at the current mobile zoom threshold.");
