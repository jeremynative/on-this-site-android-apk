...
requireBundledText('const SITE_LABEL_MIN_ZOOM = 9.35;', "Bundled Android app must show site labels at the current mobile zoom threshold.");
requireBundledText('const SITE_POINT_LABEL_MIN_ZOOM = 9.85;', "Bundled Android app must show point labels at the current mobile zoom threshold.");
