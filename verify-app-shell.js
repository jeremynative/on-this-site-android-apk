...
requireBundledText('const SITE_LABEL_MIN_ZOOM = 3.9;', "Bundled Android app must show site labels before close zoom.");
requireBundledText('const SITE_POINT_LABEL_MIN_ZOOM = 4.0;', "Bundled Android app must show point labels before close zoom.");
